      ...
      <div className="project__container bd-grid">
        ...
        <div onHide={handleClose} className="modal" backdrop="static" style={{ display: show ? 'block' : 'none' }}>
          <div className="modal-content">
            ...
            <a href={projects[projectId].gihubLink} target="_blank" rel="noreferrer" className="modal-btn" onClick={handleClose} style={{ textAlign: "center" }}>View Code &nbsp;<FontAwesomeIcon icon={faGithub} /></a>
            { projects[projectId].live === null ? '' : (<a href={projects[projectId].live} target="_blank" rel="noreferrer" className="modal-btn" onClick={handleClose} style={{ textAlign: "center", backgroundColor: "red" }}>Watch it Live! &nbsp;<FontAwesomeIcon icon={faDesktop} /></a>) }
          </div>
        </div>
      </div>
    </section>
